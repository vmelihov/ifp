jQuery(function ($) {
    ...
    var checkPass = function (_this) {
        var _parent = _this.parents(".js-validateblock"),
            _passBlock = _this.parents(".js-passBlock");

        //console.log($(".js-passValidation1").val() + " " + $(".js-passValidation2").val());
        if (_passBlock.find(".js-passValidation1").val() == _passBlock.find(".js-passValidation2").val()) {
            if (_this.val() == "") {
                checkForm(false, _parent);
            } else {
                checkForm(true, _parent);
                checkForm(true, _passBlock.find(".js-passValidation2").parents(".js-validateblock"));
            }
        } else {
            if (_this.val() == "") {
                checkForm(false, _parent);
                ...
                checkForm(true, _parent);
                checkForm(false, _passBlock.find(".js-passValidation2").parents(".js-validateblock"));
            }
        }
    }
    ...
    $(".js-checkValidation").change(function () {
        var _this = $(this),
